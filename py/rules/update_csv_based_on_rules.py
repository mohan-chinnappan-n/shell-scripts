...
"""
Script to update a given CSV file based on the given rules
...
python update_csv_based_on_rules.py --input_csv fruits.csv --output_csv fruits-5.csv --rules_file rules.txt
